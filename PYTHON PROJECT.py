...
# # PYTHON MINI PROJECT TO CALCULATE SGPA
# 
# PROJECT BY,
# 
# 58 VINIT JOSHI
...
def display():
    ...
    if e8.get() == "A":
        tk.Label(master, text ="30").grid(row=7, column=4)
        tot += 30
    if e8.get() == "B":
        tk.Label(master, text ="27").grid(row=7, column=4)
        tot += 27
    if e8.get() == "C":
        tk.Label(master, text ="24").grid(row=7, column=4)
        tot += 24
    if e8.get() == "D":
        tk.Label(master, text ="21").grid(row=7, column=4)
        tot += 21
    if e8.get() == "P":
    ...
    tk.Label(master, text=str(tot)).grid(row=8, column=5)
     
    # to display SGPA
    tk.Label(master, text=str(tot/18)).grid(row=9, column=5)
 
     
# end of display function
 
# label to enter name
tk.Label(master, text="Name of student").grid(row=0, column=0)
 
# label for prn number
tk.Label(master, text="PRN No").grid(row=0, column=3)
...
tk.Label(master, text="OSA 201").grid(row=3, column=1)
tk.Label(master, text="DS-II 202").grid(row=4, column=1)
tk.Label(master, text="EM 201").grid(row=5, column=1)
tk.Label(master, text="OOP 201").grid(row=6, column=1)
tk.Label(master, text="PYTHON 201").grid(row=7, column=1)
...
tk.Label(master, text="3").grid(row=7, column=3)
